...
def sum_until_prime_input():
    ...
    while True:
        ...
        if is_prime(x) == True:
            break
    print("The sum of the input integer is: " + str(sum))
...
def prime_gap(m):
    ...
    while True:
        y = next_prime(x)
        if next_prime(next_prime(x+1)) - next_prime(x) >= m:
            break
        x = x + 1
    return next_prime(x)
...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 5
    actual = wait_for_sum_of_cubes(140)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 3
    actual = wait_for_sum_of_cubes(29.9)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
